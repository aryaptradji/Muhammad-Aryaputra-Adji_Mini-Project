              ...
              children: [
                ...
                Center(
                  child: Text(
                    'Welcome to The Hub!',
                    style:
                        GoogleFonts.vidaloka(color: Colors.white, fontSize: 26),
                  ),
                ),
                ...
                Center(
                  child: Text(
                    ...
                    style:
                        GoogleFonts.vidaloka(color: Colors.white, fontSize: 16),
                  ),
                ),
                ...
                Consumer<RegisterViewModel>(
                  builder: (context, registerProvider, child) {
                    final repPassController =
                        registerProvider.repPassController;
                ...
                SizedBox(
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      // registerProvider.validateLogin();
                    },
